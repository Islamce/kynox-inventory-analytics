...
`analytics-logistics-engine` at `packages/logistics-engine` — confidence `verified`. 2 declared public entry point(s), 0 dependency(ies), 0 dependent(s).
...
<!-- kaaf:bodyDigest=380ba426f9d1f8de91df79f6f6f02f6ab521c5fb671fdd74b78bbaaf85019256 -->
